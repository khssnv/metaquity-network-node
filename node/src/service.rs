...
// Local Runtime types
use metaquity_network_runtime_common::{AccountId, AuraId, Balance, Block, Nonce};
...
impl NativeExecutionDispatch for DevnetRuntimeExecutor {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		metaquity_network_devnet_runtime::api::dispatch(method, data)
	}

	fn native_version() -> sc_executor::NativeVersion {
		metaquity_network_devnet_runtime::native_version()
	}
}
...
impl NativeExecutionDispatch for MainnetRuntimeExecutor {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		metaquity_network_mainnet_runtime::api::dispatch(method, data)
	}

	fn native_version() -> sc_executor::NativeVersion {
		metaquity_network_mainnet_runtime::native_version()
	}
}
